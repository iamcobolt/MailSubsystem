...
impl Database {
    ...
    pub async fn claim_unanalyzed_emails_for_account(
        ...
        self.claim_unanalyzed_emails_for_account_with_lock_ttl(
            account_id,
            worker_id,
            limit,
    ...
    pub async fn claim_unanalyzed_emails_for_account_with_lock_ttl(
        &self,
        account_id: &str,
        worker_id: &str,
        limit: u32,
        ...
        self.claim_analysis_emails_for_account(account_id, worker_id, limit, false, lock_ttl_secs)
            .await
    }
